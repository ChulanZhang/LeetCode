...
def create_folders():
    ...
    reference_plans_path = os.path.join(WORKSPACE_ROOT, "reference", "plans")
    if not os.path.exists(reference_plans_path):
        os.makedirs(reference_plans_path)
        print("  Created directory: reference/plans")
...
def compile_study_guide_html():
    ...
    html_path = os.path.join(WORKSPACE_ROOT, "reference", "plans", "blind75_study_guide.html")
...
def generate_pdf():
    ...
    html_path = os.path.join(WORKSPACE_ROOT, "reference", "plans", "blind75_study_guide.html")
    pdf_path = os.path.join(WORKSPACE_ROOT, "reference", "plans", "blind75_study_guide.pdf")
    ...
    if edge_executable:
        ...
        print("  You can manually open 'reference/plans/blind75_study_guide.html' in Chrome or Edge and print to PDF.")
