...
def generate_markdown_plan():
    ...
    plan_dir = os.path.join(WORKSPACE_ROOT, "reference", "plans")
...
def render_pdf():
    ...
    html_path = os.path.join(WORKSPACE_ROOT, "reference", "plans", "30_day_sprint_plan.html")
    pdf_path = os.path.join(WORKSPACE_ROOT, "reference", "plans", "30_day_sprint_plan.pdf")
